...
namespace Juego
{
    public partial class LoginScreen : Form
    {
        ...
        SoundPlayer player = new SoundPlayer("Resources//LoginScreenMusic.wav");
        ...
        private void Sound_Pnl_Click(object sender, EventArgs e)
        {
            Sound_Pnl.Hide();
            mute_Pnl.Show();
            player.Stop();
        ...
        private void mute_Pnl_Click(object sender, EventArgs e)
        {
            mute_Pnl.Hide();
            Sound_Pnl.Show();
            player.Play();
